...
#define STRING_CONFIG_H_AUTHOR "(Rui Carneiro, default config)"// Who made the changes.
...
#define TEMP_RESIDENCY_TIME         03  // (seconds) Time to wait for hotend to "settle" in M109
#define TEMP_WINDOW                  1  // (°C) Temperature proximity for the "temperature reached" timer
#define TEMP_HYSTERESIS              5  // (°C) Temperature proximity considered "close enough" to the target

#define TEMP_BED_RESIDENCY_TIME     03  // (seconds) Time to wait for bed to "settle" in M190
...
#define MAX_FEEDRATE_EDIT_VALUES    { 500, 500, 24, 120 } // ...or, set your own edit limits
#endif
...
#define MAX_ACCEL_EDIT_VALUES       { 1000, 1000, 200, 5000 } // ...or, set your own edit limits
#endif
...
#define DEFAULT_XJERK 08.0
#define DEFAULT_YJERK 08.0
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -36.3, +1.0, -3.425 }
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   05 // Z Clearance for Deploy/Stow
...
#define Z_PROBE_OFFSET_RANGE_MIN -05
#define Z_PROBE_OFFSET_RANGE_MAX 05
...
#define NOZZLE_PARK_POINT { -1, -1, 25 }
//#define NOZZLE_PARK_X_ONLY          // X move only is required to park
//#define NOZZLE_PARK_Y_ONLY          // Y move only is required to park
#define NOZZLE_PARK_Z_RAISE_MIN   0   // (mm) Always raise Z by at least this distance
#define NOZZLE_PARK_XY_FEEDRATE 050   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
